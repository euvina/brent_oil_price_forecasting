...
st.set_page_config(layout='centered', 
                   page_title='Previsão do preço do petróleo Brent', 
...
# referências        
    ...
    st.markdown('''
                    ...
                    - [**Forecasting Oil Price Using Web-based Sentiment Analysis**](https://www.mdpi.com/1996-1073/12/22/4291)<br>
                        Energies (2019), by ZHAO, Lu-Tao; ZENG, Guan-Rong; WANG, Wen-Jing; ZHANG, Zhi-Gang
                    - [**Análise prática de séries temporais: predição com estatística e aprendizado de máquina**](https://www.amazon.com.br/Análise-Prática-Séries-Temporais-Estatística/dp/8550815624)<br>
                        Alta Books (2021), by NIELSEN, Aileen
                ''')
